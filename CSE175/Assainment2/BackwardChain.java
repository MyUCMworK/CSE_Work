	...
	// PROVIDE YOUR CODE HERE!
    	if(t1.c != null){
    		...
    		if(t2.c != null){
        		...
        		// t1 const && t2 func
        		// cannot unify functions and constants
        		// constants are always the 
        		return null;
        	}
    	}
    	else if (t1.v != null) {
			// t1 var
    		Term value = bl.boundValue(t1.v);
    		//bl.addBinding(t1.v,value);
